...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
            ...
            if (grantResults.length == VIDEO_PERMISSIONS.length) {
                for (int result : grantResults) {
                    if (result != PackageManager.PERMISSION_GRANTED) {
                        Toast.makeText(mContext, "没有获取权限", Toast.LENGTH_LONG).show();
                        break;
                    }
                }
            } else {
...
//        final File dir = context.getExternalFilesDir(null);
        ...
        return (dir == null ? "" : (dir.getAbsolutePath() + "/myvideo/"))
